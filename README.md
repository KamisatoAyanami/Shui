...
从 [Releases](https://github.com/KamisatoAyanami/Shui/releases/) 页面下载最新版本。
...
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/KamisatoAyanami/Shui)

<!-- WeChat QR code removed -->
...
<a href="https://www.star-history.com/#KamisatoAyanami/Shui&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=KamisatoAyanami/Shui&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=KamisatoAyanami/Shui&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=KamisatoAyanami/Shui&type=Date" />
 </picture>
</a>
